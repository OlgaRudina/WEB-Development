...
*
* Name: Olga Rudina Student ID: 039949136 Date: 17/05/2018
*
********************************************************************************/
...
var toFahrenheit = parseFloat(Celsius * 1.8 + 32);
console.log(Celsius + "°C is " + toFahrenheit.toFixed(2) + "°F.");
var Fahrenheit = prompt("Enter temperature in Fahrenheit ");
var toCelsius = parseFloat((Fahrenheit  -  32)  / 1.8);
console.log(Fahrenheit + "°F is " + toCelsius.toFixed(2) + "°C.");
