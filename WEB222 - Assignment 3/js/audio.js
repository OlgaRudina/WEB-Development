...
window.onload = function(){
      var audioContainer = document.querySelector("#player");
      var str1 = "<audio controls>";
      var str2 = "</audio>";
  
       for (var i=0; i<audio.source.length; i++){
             
        str1 += "<source src='" + audio.source[i].src + "' type='" + audio.source[i].type + "' ";    
        str1+=str2;
        audioContainer.innerHTML = str1;
       }          
